...
describe('Delete User By Id UC-206', function () {
    ...
    it('TC-206-4-UserSuccesfullyDeleted', (done) => {
        ...
        chai.request(server).post("/api/user?firstName=TC-206-4&lastName=TC-206-4&street=teststreet&city=testcity&emailAddress=t.TC2064@UC206.nl&password=Testpassword1!&phoneNumber=06 12345678").end((err, res) => {
